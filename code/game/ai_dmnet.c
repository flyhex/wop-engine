...
int BotSelectActivateWeapon(bot_state_t *bs) {
	...
	else if (bs->inventory[INVENTORY_SPLASHER] > 0 && bs->inventory[INVENTORY_SPLASHERAMMO] > 0)
	...
	else if (bs->inventory[INVENTORY_IMPERIUS] > 0 && bs->inventory[INVENTORY_IMPERIUSAMMO] > 0)
