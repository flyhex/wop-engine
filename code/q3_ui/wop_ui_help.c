...
#define ART_PREV0    "menu/help/arrowup0"
#define ART_PREV1    "menu/help/arrowup1"
#define ART_NEXT0    "menu/help/arrowdown0"
#define ART_NEXT1    "menu/help/arrowdown1"
...
static void UI_HelpMenu_AdjustButtons(void){
	...
	helpMenuInfo.img = trap_R_RegisterShaderNoMip(va("menu/help/%s", helpList[helpIndex]));
}
