...
=======================================================================
  ...
  @toda: split bots menu into separate file ~smiley
...
static void StartServer_MenuInit(void){
	...
	s_startserver.gametype.curvalue          = gametype_remap2[(int)Com_Clamp(0, (sizeof(gametype_remap2) /
	                                                                              sizeof(gametype_remap[0]) - 1),
	                                                                          trap_Cvar_VariableValue("ui_createGametype"))];
