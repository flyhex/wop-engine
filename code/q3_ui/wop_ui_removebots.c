...
static sfxHandle_t RemoveBotsMenu_Key(int key){
	switch(key){
		...
		case 'r':
		case 'R':
			UI_RemoveBotsMenu_DeleteEvent(&removeBotsMenuInfo.
			delete, QM_ACTIVATED );
			break;
	}
...
static void UI_RemoveBotsMenu_Init(void){
	...
	removeBotsMenuInfo.
	delete.generic.type = MTYPE_TEXTS;
	removeBotsMenuInfo.
	delete.fontHeight = 24.0f;
	removeBotsMenuInfo.
	delete.generic.flags = QMF_RIGHT_JUSTIFY;//|QMF_PULSEIFFOCUS;
	removeBotsMenuInfo.
	delete.generic.callback = UI_RemoveBotsMenu_DeleteEvent;
	removeBotsMenuInfo.
	delete.generic.id = ID_DELETE;
	removeBotsMenuInfo.
	delete.generic.x = 380;
	removeBotsMenuInfo.
	delete.generic.y = 280;
	removeBotsMenuInfo.
	delete.string = "REMOVE";
	removeBotsMenuInfo.
	delete.style = UI_SMALLFONT | UI_RIGHT;
	removeBotsMenuInfo.
	delete.color = color_black;
	removeBotsMenuInfo.
	delete.focuscolor = color_orange;
	...
	Menu_AddItem(&removeBotsMenuInfo.menu, &removeBotsMenuInfo.
	delete );
